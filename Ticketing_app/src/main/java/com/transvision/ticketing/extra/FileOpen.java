    ...
    public static void openFile(Context context, File url) {
        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                uri = FileProvider.getUriForFile(context, context.getApplicationContext().getPackageName() + ".provider", url);
            } else uri = Uri.fromFile(url);
            ...
            if (url.toString().contains(".doc") || url.toString().contains(".docx")) {
                ...
                intent.setDataAndType(uri, "application/vnd.ms-powerpoint");
                    ...
                    (url.toString().contains(".xls") || url.toString().contains(".xlsx")) {
                // Excel file
